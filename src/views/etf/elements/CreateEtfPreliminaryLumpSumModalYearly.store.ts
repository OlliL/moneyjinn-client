...
export const useCreateEtfPreliminaryLumpSumModalYearlyStore = defineStore(
  "createEtfPreliminaryLumpSumYearlyModal",
  () => {
    ...
    const openEditEtfPreliminaryLumpSumYearly = (
      etfId: number | undefined,
...
export default useCreateEtfPreliminaryLumpSumModalYearlyStore;
