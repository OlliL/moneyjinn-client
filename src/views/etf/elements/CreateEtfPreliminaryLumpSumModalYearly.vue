<template>
  <ModalVue
    :title="title"
    max-width="max-w-md"
    id-suffix="CreateEtfPreliminaryLumpSumYearly"
    v-model:open="open"
  >
    <template #body>
      <form
    ...
    <template #footer>
      <Button
        ...
        data-testid="createEtfPreliminaryLumpSumYearlyResetButton"
        @click="resetForm"
      >
      ...
      <ButtonSubmit
        ...
        test-id="createEtfPreliminaryLumpSumYearlySaveButton"
      >
